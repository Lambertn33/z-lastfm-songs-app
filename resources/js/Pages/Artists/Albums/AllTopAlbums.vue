<template>
    ...
    <div class="bg-[#262626] p-8">
        ...
        <!--Navigation-->
        <the-navigation :currentPage="parseInt(artist_all_top_albums['@attr'].page)"
            :totalPages="parseInt(artist_all_top_albums['@attr'].totalPages)" :pageCount="pageCount" :isFirstPage="pageCount < 2"
